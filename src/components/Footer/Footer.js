    ...
    return (
        <div className="footer_section">
            <div className="section_contact">
                <div data-aos="fade-right" data-aos-duration="1500" className="section_contact__left">
                ...
                <div data-aos="fade-left" data-aos-duration="1500"  className="section_contact__right">
                    <div className="contact">
                        <div className='sh__left_name'>
